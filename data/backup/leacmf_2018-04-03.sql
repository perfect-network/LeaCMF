...
# Database: leacmf
# Generation Time: 2018-04-03 02:24:08 +0000
# ************************************************************
...
VALUES
	(1,'admin','admin','$2y$10$wBqQmkeBqpLIlNTtpjlsyO3AiuwmNU0RVmLQgkes6FueVxfEolXYi',13,'eae86dd2a5cad172f1fd9fbc61a417f7',727,1522721284,'192.168.66.1',1,1),
	(2,'manage','管理员','$2y$10$wBqQmkeBqpLIlNTtpjlsyO3AiuwmNU0RVmLQgkes6FueVxfEolXYi',0,'$2y$10$qIwwvblkQETKaKBtiBTMO.T.K',47,1504764750,'1.25.227.160',1,1496306374);
...
VALUES
	(1,'web_site_title',1,'网站标题',1,'','网站标题前台显示标题',1378898976,1494505103,0,'leacm管理系统',0),
	...
	(15,'sms_template',1,'短信模板',5,'','用于配置注册和找回密码时发送短信的模板，{code}为验证码。',0,0,0,'【家长思维】您的验证码是{code}，请在5分钟内填写。',0),
	(16,'pay_time_limit',0,'支付限时',5,'','单位：分钟',0,0,0,'30',0),
	(17,'web_copyright',1,'版权设置',1,'','',0,0,0,'北京睿亿网络科技有限公司',0);
